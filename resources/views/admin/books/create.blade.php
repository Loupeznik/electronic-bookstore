                            ...
                            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <x-input-select id="author" name="author_id" class="w-full" required>
                                    @forelse ($authors as $author)
                                        <option value="{{ $author->id }}">{{ $author->surname . ' ' . $author->name }}
                                        </option>
                                    @empty
                                        <option id="-">-</option>
                                    @endforelse
                        ...
                        <div class="-mx-3 md:flex mb-6">
                            ...
                            <div class="md:w-1/2 px-3">
                                ...
                                <x-input id="sale_price" name="sale_price" class="w-full" type="text"
                                    pattern="^\d*(\.\d{0,2})?$" value="{{ old('sale_price') }}" />
                            </div>
                        </div>
                        <div class="-mx-3 md:flex mb-6">
                            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="flex flex-wrap mb-6">
                            <div class="relative w-full">
                                <div class="mt-4 w-full">
                                    ...
                                    <x-input id="isbn" name="isbn" type="text" class="w-full">{{ old('isbn') }}</x-input>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-wrap mb-6">
                            <div class="relative w-full">
                                <div class="mt-4 w-full">
                                    ...
                                    <x-input-textarea name="description" class="w-full" id="desc">{{ old('description') }}</x-input-textarea>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-wrap mb-6">
